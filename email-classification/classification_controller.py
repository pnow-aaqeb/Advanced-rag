from nest.core import Controller, Get, Post, Injectable, Logger, Query, Body, Param
...
class ClassificationController:
    def __init__(self, manual_email_classifier: 'ManualEmailClassifier'):
        self.classifier = manual_email_classifier
        # self.logger = Logger('ClassificationController')
    ...
    @Get('/results')
    async def get_classification_results(self, skip: int = Query(0), limit: int = Query(500)):
        try:
